...
/**
 * Valid values for this variable: development, staging, production.
 */
 ...
 * SMTP configuration.
 */
# $config['smtp.settings']['smtp_username'] = 'username';
# $config['smtp.settings']['smtp_from'] = 'from@mail.com';
# $config['smtp.settings']['smtp_fromname'] = 'Sitename';
...
# $config['search_api.server.solr']['backend_config']['connector_config' ]['core'] = 'corename';
# $config['search_api.server.solr']['backend_config']['connector_config' ]['port'] = '8983';

/**
 * Recaptcha credentials.
 */
# $config['recaptcha.settings']['site_key'] = 'site key';
# $config['recaptcha.settings']['secret_key'] = 'secret key';
